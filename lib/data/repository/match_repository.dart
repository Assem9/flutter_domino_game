...
class MatchRepository{
  ...
  DominoMatch reInitializeBoardDataForTheNewRound({required DominoMatch match}){
    ...
    distributePieces(player: match.playerOne, board: match.dominoBoard, noOfPiece: 7);
    distributePieces(player: match.playerTwo, board: match.dominoBoard, noOfPiece: 7);
