...
import '../models/unKnown_error.dart';
...
//////////////////////////////////// Sign in With google ////////////////////////////////////////////////
  ...
  Future<UnExpectedError> createUnExpectedError({
    ...
    error.getDeviceInfo().then((value) async{
      error.iD = UserRepository(UserFireBaseServices()).generateUniqueId('error');
      await authServices.addErrorDataDocToFireStore(error);
    });
