    ...
    return Scaffold(
      ...
      body: BlocConsumer<AuthCubit,AuthStates>(
        listener: (context, state){
          if(state is FireBaseUnExpectedError){
            Navigator.pushNamed(context, unExpectedErrorScreen,arguments: state.errorData);
          }
          ...
          if(state is UserSignedUp){
            Navigator.pushNamedAndRemoveUntil(
              context,
              verifyingEmailScreen, (route) => false,
              arguments: {
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            AppLogoWidget(radius: MediaQuery.of(context).size.width/7),//50
                            Expanded(
