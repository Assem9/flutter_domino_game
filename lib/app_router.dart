...
import 'package:domino_game/presentation/screens/unExpected_error_screen.dart';
...
class AppRouter{
  ...
  Route? generateRoute(RouteSettings settings){
    switch (settings.name){
      ...
      case unExpectedErrorScreen :
        final errorData = settings.arguments as String ;
        return MaterialPageRoute(
          builder: (_) => BlocProvider.value(
              value: authCubit,
              child: UnExpectedErrorDataScreen(errorData: errorData) ,
          ),
        );
      case home:
        return MaterialPageRoute(
